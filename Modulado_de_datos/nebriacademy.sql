...
(1, 2, '12345678B', 'Nicolás', 'García Sampedro', 'nico@example.com', 'pass123', '4111111111111111', '611111111', '@nicostudent', 'España', 'Sevilla'),
(2, 3, '87654321C', 'María', 'López Díaz', 'maria@example.com', 'pass456', '4222222222222222', '622222222', '@marialopez', 'España', 'Valencia');
...
CREATE TABLE `profesores` (
  ...
  `email` varchar(100) NOT NULL,
  `contrasena` varchar(255) NOT NULL,
  `numCuentaBancaria` varchar(50) NOT NULL,
  `numTelefono` varchar(30) DEFAULT NULL,
  `redes` text DEFAULT NULL,
  `pais` varchar(50) DEFAULT NULL,
  `localidad` varchar(50) DEFAULT NULL,
...
(1, 4, '11111111D', 'Sofía', 'Martínez Ruiz', 'sofia@prof.com', 'prof123', 'ES9820385778983000760236', '633333333', '@profeSofia', 'España', 'Barcelona', 'Programación'),
